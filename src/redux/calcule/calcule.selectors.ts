...
export const selectCalculeWithCompany = (rootReducer: RootState) => {   
    const services = rootReducer.companyReducer.services
    ...
    return {
        ...
        profit_margin: rootReducer.calculeReducer.profit_margin || services[0].margin_profit,
        estimated_time: rootReducer.calculeReducer.estimated_time || services[0].estimated_time,
        additionals: rootReducer.calculeReducer.additionals || services[0].additionals,
    } as CalculeStateType
}